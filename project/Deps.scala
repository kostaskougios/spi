...
object Deps {
  val ScalaVersion = "2.13.8" // see mock-spark if you change scala's major version
  ...
  object Spark {
    ...
    val CassandraConnector = "com.datastax.spark" %% "spark-cassandra-connector" % "3.1.0"
  ...
  object Libraries {
    ...
    val SqlLike = "org.scalikejdbc" %% "scalikejdbc" % "3.5.0"
